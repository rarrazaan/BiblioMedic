...
<head>
    ...
    <title>Signup &mdash; Bibliomedic</title>
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img style="border-radius:5px;" src="{{ asset('assets/images/favicon.png')}}" alt="logo"
                                width="80">
                        </div>

                        <div class="card card-primary">
                            <div class="card-header">
                                <h4 class="text-primary">Signup Bibliomedic</h4>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <form method="POST" action="{{ url('/user/signup') }}" class="needs-validation"
                                    novalidate="">
                                    @csrf
